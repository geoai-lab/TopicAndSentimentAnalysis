...
public class NeighborhoodReview implements Comparable<NeighborhoodReview>, Serializable
{
	...
	public class Sentence implements Comparable<Sentence>, Serializable {		
		...
		public int AnnotateByKeyword(Set<String> keywords){
			int count = 0;
			for(Token t:m_tokens){
				/*if("safe".equals(t.m_lemma))
					System.out.println("tested");
				System.out.println(t.m_lemma);*/
	...
	public String m_neighborID;   // This is the name of the neighborhood
	public String m_reviewID;   // This is the id of a review, which is neighborhood + author ID
	public String m_author;
	public String m_content;
	public String m_date;
	public int m_overall_rating;
	...
	public NeighborhoodReview(String neighborID, String reviewID, int overallRaing, String reviewContent){
		m_neighborID = neighborID;
		m_reviewID = reviewID;
		m_annotated = false;
		m_stns = new Vector<Sentence>();
		m_overall_rating = overallRaing;
		m_content = reviewContent;
	/*	if (ratings!=null){
	...
	public String toPrintString(){
		...
		buffer.append("<Neighborhood ID>" + m_neighborID + "\n");
		...
		for(int i=0;i<m_stns.size();i++)
			buffer.append(m_stns.get(i).toString()+"\n");
		buffer.append("\n");
	...
	@Override
	public int compareTo(NeighborhoodReview o) {
